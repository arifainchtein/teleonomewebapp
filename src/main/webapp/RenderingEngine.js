	...
	if(telepathonsNuclei != undefined){
		...
		var currentFunctionTitle;
			for(var j13=0;j13<deneChains.length;j13++){
				...
				panelHTML += '<div class="" style="font-size:12px"><button class="delete-telepathon" data-telepathonname="'+ telepathonName +'" type="button" aria-label="Close" data-dismiss="modal"><span aria-hidden="true">×</span></button></div>';
				panelHTML +='</div>';
