	...
	if(telepathonsNuclei != undefined){
		...
		var currentFunctionTitle;
			for(var j13=0;j13<deneChains.length;j13++){
				...
				panelHTML += '<div class="text-center" style="font-size:16px">'+telepathonName+'</div>';
				panelHTML += '<div class="	" style="font-size:12px"><button class="btn btn-sm btn-danger delete-telepathon" data-telepathonname="'+ telepathonName +'" type="button" aria-label="Close" data-dismiss="modal"><i class="fa fa-close"></i></button></div>';
				panelHTML +='</div>';
