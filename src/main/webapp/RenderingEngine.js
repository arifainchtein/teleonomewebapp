	...
	if(telepathonsNuclei != undefined){
		...
		var currentFunctionTitle;
			for(var j13=0;j13<deneChains.length;j13++){
				...
				panelHTML += '<div class="	" style="font-size:12px"><button class="btn btn-sm btn-danger delete-telepathon" data-telepathonname="'+ telepathonName +'" type="button" aria-label="Close" data-dismiss="modal"></button></div>';
				panelHTML +='</div>';
