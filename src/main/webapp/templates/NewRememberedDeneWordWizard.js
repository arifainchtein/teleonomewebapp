class NewRememberedDeneWordWizard{
    ...
    process1(){
        ...
        panelHTML += "<div class=\"modal fade bs-example-modal-lg\" tabindex=\"-1\" id=\"NewRememberedDeneWordWizard\" role=\"dialog\" aria-labelledby=\"ModalHeadingText\" aria-hidden=\"true\">";
        ...
        panelHTML += "               <h4 class=\"modal-title\" id=\"ModalHeadingText\">Start Remembering</h4>";
        panelHTML += "           </div>";
        ...
        panelHTML += "                              <div class=\"well\" id=\"NewRememberedWordIdentity\" ></div>";
        panelHTML += "                              <div id=\"NewRememberedWordOrganismView\" class=\"row\"></div>";
        panelHTML += "                              <div id=\"NewRememberedWordNucleusView\" class=\"row\"></div>";
        panelHTML += "                              <div id=\"NewRememberedWordDeneChainView\" class=\"row\"></div>";
        panelHTML += "                              <div id=\"NewRememberedWordDeneView\" class=\"row\"></div>";
