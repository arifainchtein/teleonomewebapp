class DiagnosticsInfo{
    ...
    process(){
        ...
        panelHtml +='                       </div>';
        panelHtml +='                       <div class="col-lg-1 col-xs-2 DiagnosticsBar">';
        panelHtml +='                           <span id="SystemDiagnostics" data-panelpointer="System Diagnostics Panel" class="text-center DiagnosticsMenu"><i class="glyphicon glyphicon-signal"></i><br>System</span>';
        panelHtml +='                       </div> ';          
        panelHtml +='                   </div> ';   
