class SearchPanel{
    ...
    process(){
        ...
        if(screensize>500){
			...
			panelHTML += "                                    <div class=\"form-group col-md-3\">";
	        panelHTML += "                                        <div class=\"form-check form-check-inline\">";
	        panelHTML += "                                            <input class=\"form-check-input \" type=\"input\" id=\"LiveUpdateMinutes\" value=\"60\">";
	        ...
	        panelHTML += "                                        <div class=\"form-check form-check-inline\">";
	        panelHTML += "                                            <input class=\"form-check-input BSswitch\" type=\"checkbox\" id=\"LiveUpdate\" value=\"option2\">";
	        panelHTML += "                                            <label class=\"form-check-label BSswitch\" for=\"LiveUpdate\">Live Update</label>";
	        panelHTML += "                                        </div>";
	        panelHTML += "                                    </div>";
	        panelHTML += "                                </div>";
	        panelHTML += "                                <div class=\"form-row\">";
