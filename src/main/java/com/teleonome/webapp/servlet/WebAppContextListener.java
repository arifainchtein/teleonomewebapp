...
public class WebAppContextListener implements ServletContextListener {
	...
	public final static String BUILD_NUMBER="17/03/2026 09:36";
	...
	class PingThread extends Thread{
		...
		public void run(){
			while(true) {
				...
				JSONObject denomeJSONObject=null,hippocampusStatusJSONObject=new JSONObject();
				...
				do {
					try {
						...
						File hippoFile = new File("HippocampusStatus.json");
						long now =  System.currentTimeMillis();
						boolean hipocampusActive = false;
						if(hippoFile.isFile()) {
							hippocampusStatusJSONObject = new JSONObject(FileUtils.readFileToString(hippoFile));
