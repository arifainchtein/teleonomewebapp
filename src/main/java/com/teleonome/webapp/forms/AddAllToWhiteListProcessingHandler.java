...
public class AddAllToWhiteListProcessingHandler extends ProcessingFormHandler {

	public AddAllToWhiteListProcessingHandler(HttpServletRequest req, HttpServletResponse res,
	...
	//	String deviceMacAddress = request.getParameter("DeviceMacAddress");
		...
		String value = "AddAllDevicesToWhiteList";
